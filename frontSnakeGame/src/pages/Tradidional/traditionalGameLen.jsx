...
const TraditionalGame = () => {
  ...
  const { selectedColor, idSala, selectedValue, selectedValue2, largo } = location.state;
  ...
  const handleFoodConsumption = newSnakeCells => {
    ...
    setScore(score + 1);
    console.log('Score:', score, 'Largo:', largo);


    // alerta para finalizar aqui va logica de crear estadisticas 
    if (score == largo) {
      console.log('Game over!');
